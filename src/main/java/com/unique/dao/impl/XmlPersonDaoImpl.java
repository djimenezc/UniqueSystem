 ...
 * @author djimenez
 */
public class XmlPersonDaoImpl extends FileGenericDao<PersonTo,Long>  implements PersonDao {

	public XmlPersonDaoImpl(Class<PersonTo> persistentClass, String sourceFile) {
